  ...
  <div class="login-view">
    ...
    <div class="login-view__content">
      <section class="login-view__hero">
        ...
        <p class="login-view__eyebrow">Base frontend SimUI</p>
...
const authIntro = 'Connectez-vous pour acceder a votre espace applicatif.'
...
const handleLogin = async () => {
  ...
  const validation = validateLoginCredentials(credentials.value)
