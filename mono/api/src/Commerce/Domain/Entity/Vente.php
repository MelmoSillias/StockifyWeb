...
class Vente
{
    ...
    public function addLine(Uuid $variantId, string $label, string $quantity, string $unitPrice): VenteLine
    {
        $line = new VenteLine($this, $variantId, $label, $quantity, $unitPrice);
        $this->lines->add($line);
