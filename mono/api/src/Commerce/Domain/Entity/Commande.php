...
class Commande
{
    ...
    public function addLine(Uuid $variantId, string $label, string $quantity, string $unitPrice): CommandeLine
    {
        $this->assertMutable();
        $line = new CommandeLine($this, $variantId, $label, $quantity, $unitPrice);
        $this->lines->add($line);
