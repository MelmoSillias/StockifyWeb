 ...
 */
final class Version20260713051132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE paiement_credit_client (id INT AUTO_INCREMENT NOT NULL, credit_id INT NOT NULL, user_id INT DEFAULT NULL, paiement_credit_client_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL, INDEX IDX_B3130F7ACE062FF9 (credit_id), INDEX IDX_B3130F7AA76ED395 (user_id), UNIQUE INDEX UNIQ_B3130F7A3C017514 (paiement_credit_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, reference VARCHAR(255) DEFAULT NULL, categorie VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, stock_actuel INT NOT NULL, pme DOUBLE PRECISION NOT NULL, seuil_alerte INT DEFAULT NULL, actif TINYINT(1) NOT NULL, prix_de_vente NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE transaction_caisse (id INT AUTO_INCREMENT NOT NULL, vente_id INT DEFAULT NULL, paiement_credit_id INT DEFAULT NULL, paiement_fournisseur_id INT DEFAULT NULL, date DATETIME NOT NULL, type VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, libelle VARCHAR(255) DEFAULT NULL, description VARCHAR(255) NOT NULL, motif VARCHAR(255) NOT NULL, INDEX IDX_C4DE21887DC7170A (vente_id), UNIQUE INDEX UNIQ_C4DE21888C051B3 (paiement_credit_id), UNIQUE INDEX UNIQ_C4DE2188F62D7802 (paiement_fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, full_name VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT '(DC2Type:json)', password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, actif TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649DBC463C4 (full_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE vente (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, date DATETIME NOT NULL, nom_client VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, total DOUBLE PRECISION NOT NULL, montant_paye DOUBLE PRECISION NOT NULL, reste DOUBLE PRECISION NOT NULL, benefice DOUBLE PRECISION NOT NULL, INDEX IDX_888A2A4CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
