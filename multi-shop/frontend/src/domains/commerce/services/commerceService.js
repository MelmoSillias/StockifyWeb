...
export const commerceService = {
  ...
  async createDevis(payload) {
    const response = await apiClient.post('/devis', payload)
    return response.data
  },
  async cancelDevis(id) {
    const response = await apiClient.post(`/devis/${id}/cancel`)
    return response.data
  },
  async convertDevisToVente(id, payload) {
    const response = await apiClient.post(`/devis/${id}/convert/vente`, payload)
    return response.data
  },
  async convertDevisToCommande(id, payload) {
    const response = await apiClient.post(`/devis/${id}/convert/commande`, payload)
    return response.data
  },
