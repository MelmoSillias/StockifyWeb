...
final class AnalyticsController extends AbstractController
{
    ...
    {
        $this->assertAnalyticsEntitlement($request);
        try {
    ...
    private function assertAnalyticsEntitlement(Request $request): void
    {
        ...
        $shop = $this->shopRepository->findById(\Symfony\Component\Uid\Uuid::fromString($shopId));
        if (null === $shop) {
            return;
        }

        $this->tenantFeatureGuard->assertFeatureForShop($shop, 'stockify.analytics');
    }
}
