...
#[ORM\UniqueConstraint(name: 'uniq_variant_shop_sku', columns: ['shop_id', 'sku'])]
#[ORM\UniqueConstraint(name: 'uniq_variant_combo', columns: ['shop_id', 'product_id', 'unit_of_measure_id', 'sale_mode'])]
